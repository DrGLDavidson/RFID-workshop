---
title: "3. RFID Tutorial: Nestboxes with visit counters"
...
```
### Download resources necessary for the workshop and save them to your workspace
...
#set working directory so R knows where to find and save data. This is the folder you created when you made a workspace above. So for example, my workspace is below, but yours will be a different file path. 
...
```
### **EXERCISE 3.2 Nestbox visit frequencies 
...
## 3.4 filter your data to be wtihin range of dates/times
...
# END OF RFID TUTORIAL NESTBOXES 
