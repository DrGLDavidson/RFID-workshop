...
```{r}
#As we will be working with time, we need to change the class of the Date column as a POSIX class. 
df2<-df2%>%
...
#NA is given if it is the birds' first visit of the dataframe
...
#it appears that visit frequency drops after 2 seconds and there are a small fraction that occur from 5 seconds. 
#Most of the literature does a cut off at 2 or 3 seconds. 

#Filter dataset to remove visits that were within 3 seconds of eachother
...
write.table(df7, file = "s.txt",sep="\t",row.names=FALSE)
```
