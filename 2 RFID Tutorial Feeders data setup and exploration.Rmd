...
# Imagine you have collected data from three RFID feeders deployed in the field. When you save the data from the SD card, you save it according to the date you collected it, and the feeder ID (in this case F01, F02, F03)
...
```{r}
#Imagine you want to have all the sunheart RT files as a single .txt file over all the days you took the data (e.g. the sunheart folder with all the different dated subfolders):
