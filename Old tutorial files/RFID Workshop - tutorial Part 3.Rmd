...
##need to create a dataframe once you run the latencyFunction 

latency2<-LatencyFunction(myDF=df2, RefTagrownum=2)

latency3<-LatencyFunction(myDF=df2, RefTagrownum=3)

latency1<-LatencyFunction(myDF=df2, RefTagrownum=1)
